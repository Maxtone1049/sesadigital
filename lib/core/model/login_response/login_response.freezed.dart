...
abstract class $LoginResponseCopyWith<$Res> {
  ...
  $Res call({String? status, Data? data, String? message, int? code});
...
class _$_LoginResponse implements _LoginResponse {
  _$_LoginResponse({this.status, this.data, this.message, this.code});
  ...
  @override
  String toString() {
    return 'LoginResponse(status: $status, data: $data, message: $message, code: $code)';
  }
...
abstract class _LoginResponse implements LoginResponse {
  factory _LoginResponse(
      ...
      final Data? data,
      final String? message,
      final int? code}) = _$_LoginResponse;
